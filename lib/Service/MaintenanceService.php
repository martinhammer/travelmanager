 ...
 *
 * Wiping clears the extracted bookings, the IMAP dedup ledger and the
...
class MaintenanceService {
	...
	public function wipeUserData(string $userId): void {
		...
		$this->activityLog->warning(
			...
			'Wiped extracted bookings, processed-message ledger and tasks — mailbox will be reprocessed from scratch',
		);
	}
}
