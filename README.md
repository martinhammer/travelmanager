...
* Currently there is 1:N relationship between email message and bookings. In other words, a later email will not update an existing booking (it might create a duplicate or fail to do anything).
